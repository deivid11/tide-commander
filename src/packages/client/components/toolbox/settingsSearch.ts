...
export const SETTINGS_SEARCH_SECTIONS: readonly SettingsSearchSection[] = [
  ...
  { id: 'defaultSkills', title: 'Default Agent Skills', keywords: ['skills', 'default', 'default skills', 'default agent skills', 'spawn', 'agent', 'preselect', 'pre-selected', 'tracking', 'label', 'context', 'prompt', 'overhead', 'new agent', 'habilidades'] },
