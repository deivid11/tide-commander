...
export function Toolbox({ onConfigChange, onToolChange, config, isOpen, onClose, onOpenBuildingModal, onOpenAreaExplorer, onOpenIntegrationsModal, onOpenMonitoringModal, onOpenWorkflowEditor, onOpenTriggerManager }: ToolboxProps) {
    ...
    <>
      ...
      <aside className="toolbox">
        ...
        <div className="toolbox-content">
          ...
          {/* Config Section */}
          <ConfigSection config={config} onChange={onConfigChange} searchQuery={searchQuery} onOpenIntegrationsModal={onOpenIntegrationsModal} onOpenMonitoringModal={onOpenMonitoringModal} onOpenWorkflowEditor={onOpenWorkflowEditor} onOpenTriggerManager={onOpenTriggerManager} />
        </div>
      </aside>
    </>
  );
