...
export type PluginOutputData = PluginShellCommandExecData | PluginShellCommandSudoRequestData | PluginAgentNameProposalsData | PluginRecommendedTasksData | PluginTaskListData | PluginProviderUsagesData | Record<string, unknown> | unknown[] | string | number | boolean | null;
