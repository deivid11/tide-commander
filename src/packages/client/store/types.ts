...
export interface Settings {
  ...
  experimentalWebSpeechSTT: boolean;
...
export const DEFAULT_SETTINGS: Settings = {
  ...
  experimentalWebSpeechSTT: false,
...
export interface StoreState {
  ...
  // When true, the explorer panel should also reveal/select the path in its tree.
  fileViewerRevealInTree: boolean;
  ...
  // Whether the bottom AgentBar is hidden (toggleable via header button)
