...
<CardGrid>
  ...
  <Card title="Computer Use" icon="terminal">
    Opt-in control of the local Linux desktop through windows, accessibility trees, screenshots, semantic actions, pointer input, and keyboard input.
  </Card>
</CardGrid>
