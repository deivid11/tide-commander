...
<Tabs>
  ...
  <TabItem label="Models">
    ...
    | `claude-fable-5[1m]` | Fable 5 \[1M\] | 1M tokens | Previous Fable generation |
    ...
    The default selection in the Spawn dialog is **Opus 4.8 \[1M\]**; **Fable 5.1 \[1M\]**, **Fable 5 \[1M\]**, and **Opus 5 \[1M\]** are selectable. Fable 5.1 uses its canonical `claude-fable-5-1` ID and provides a native 1M context window. Older explicit IDs remain valid for existing agents.
  </TabItem>
