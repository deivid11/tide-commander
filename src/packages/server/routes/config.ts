...
const CONFIG_CATEGORIES: ConfigCategory[] = [
  ...
  },
  {
    ...
    files: ['system-prompt.json', 'echo-prompt-setting.json', 'codex-binary-path.json', 'tmux-mode-setting.json', 'interactive-mode-setting.json', 'default-agent-skills.json'],
    sourceDir: 'data',
  },
  {
    id: 'whatsapp',
