...
/**
 * Plain-text MIME alternatives generated by email templates often contain layout
 * indentation and dozens of empty lines. The slash-command renderer is not an HTML
 * client, so normalize that layout noise while preserving intentional paragraphs.
 */
...
function toPendingItem(message: EmailMessage): GmailPendingItem {
  return {
    ...
    body: normalizeDisplayBody(message.body),
    date: message.date,
