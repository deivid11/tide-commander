...
[{
  ...
  "model": "<optional: claude-fable-5-1 | claude-fable-5[1m] | claude-fable-5 | claude-opus-5-5[1m] | claude-opus-5-5 | claude-opus-5[1m] | claude-opus-5 | opus[1m] | claude-opus-4-7 | claude-sonnet-4-6 | claude-haiku-4-5 | etc.>",
