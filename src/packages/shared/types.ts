...
//   - agent-types.ts: Agent classes, status, providers, models, context, subagents, boss, work plans
//   - building-types.ts: Buildings, PM2, Docker configuration
//   - database-types.ts: Database engines, connections, queries, tables
//   - common-types.ts: Drawing, tools, skills, events, permissions, notifications, secrets, exec tasks
